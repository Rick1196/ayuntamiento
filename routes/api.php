...
//sitios
Route::get('/get-sitios/{filtro}', 'SitiosController@getSitios')->name('get.sitios');
Route::post('/postSitio', 'SitiosController@postSitio');
Route::delete('/deleteSitio/{id}', 'SitiosController@deleteSitio');
