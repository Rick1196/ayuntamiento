...
<div class="container">
    ...
    <div class="collapse" id="C1">
        <div class="card card-body">
            <a class="btn btn-light btn-lg btn-block" href="<?php echo e(asset('/transparencia/Ley_general_Gubernamental.pdf')); ?>">
            ...
            <a class="btn btn-light btn-lg btn-block" href="<?php echo e(asset('/transparencia/Cumplimiento_ley_FISM.pdf')); ?>">
    ...
    <div class="collapse" id="C4">
        <div class="card card-body">
            ...
            <div class="collapse" id="C43">
                <div class="card card-body">
                <a class="btn btn-light btn-lg btn-block" href="<?php echo e(asset('/transparencia/manual_operacion.pdf')); ?>">
    ...
    <div class="collapse" id="C5">
        <div class="card card-body">
            <a class="btn btn-light btn-lg btn-block" href="<?php echo e(asset('/transparencia/PlanDesarrolloPrincipios.pdf')); ?>">
            PLAN DE DESARROLLO MUNICIPAL DE TOLUCA 2016-2018
            </a>
            <a class="btn btn-light btn-lg btn-block" href="<?php echo e(asset('/transparencia/ccdT.pdf')); ?>">
