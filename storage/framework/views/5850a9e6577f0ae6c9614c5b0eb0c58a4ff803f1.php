...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-danger"><?php echo e(__('Registro')); ?></div>
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control<?php echo e($errors->has('rol_selected') ? ' is-invalid' : ''); ?>" id="rol_selected" name="rol_selected">
                                ...
                                <?php if($errors->has('rol_selected')): ?>
                                    <span class="invalid-feedback" role="alert">
                                        <strong><?php echo e($errors->first('rol_selected')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
