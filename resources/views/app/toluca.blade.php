  ...
  <div class="card-header" role="tab" id="heading4">
    <a data-toggle="collapse" data-parent="#accordionEx1" href="#collapse4" aria-expanded="true"
      ...
      <h4 class="text-center mb-0 mt-3 red-text">
        PALACIO DE GOBIERNO <i class="fa fa-angle-down rotate-icon fa-2x"></i>
      </h4>
    </a>
  </div>
...
<div class="card">
  ...
  <div class="card-header" role="tab" id="heading5">
    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#collapse5" aria-expanded="false"
      ...
      <h4 class="text-center mb-0 mt-3 red-text">
       PALACIO DEL PODER LEGISLATIVO <i class="fa fa-angle-down rotate-icon fa-2x"></i>
      </h4>
    </a>
  </div>
...
<div class="card">
  ...
  <div class="card-header" role="tab" id="heading6">
    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx1" href="#collapse6" aria-expanded="false"
      ...
      <h4 class="mb-0 mt-3 red-text text-center">
        PALACIO MUNICIPAL <i class="fa fa-angle-down rotate-icon fa-2x"></i>
      </h4>
    </a>
  </div>
